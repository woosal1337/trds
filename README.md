...
| React | `@kiris-ds/react` | kararlı | `npm install @kiris-ds/react @kiris-ds/core @kiris-ds/theme-vatandas` |
| Next.js | `@kiris-ds/react` | beta | `npm install @kiris-ds/react @kiris-ds/core @kiris-ds/theme-vatandas` |
