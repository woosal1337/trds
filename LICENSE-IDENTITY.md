...
lisanslıdır. Her simge serbestçe kullanılır. Lisans metni
`packages/identity/src/simgeler/LICENSE-TABLER.txt` içindedir.
...
Bu parçalar yalnız şu koşullarda kullanılabilir:

1. Hizmet, bir Türkiye Cumhuriyeti kamu kurumu tarafından işletilir veya o
   kurum adına yürütülür.
2. Hizmet, `gov.tr` uzantılı bir alan adında yayımlanır.
3. Kullanım, hizmetin gerçek kimliğini gösterir ve bir taklit oluşturmaz.

## Yasak kullanım

Bu parçalar şu amaçlarla kullanılamaz:

- Bir devlet hizmetini taklit etmek
- Kullanıcıyı hizmetin sahibi konusunda yanıltmak
...
Bu ayrım Fransa (DSFR, Etalab 2.0 lisansı ve kullanım koşulları) ve İrlanda
(GOV.IE yönetişim belgesi) uygulamalarından alındı.

Kod herkese açık olmalıdır, çünkü yeniden kullanım kamuya fayda sağlar.
Devlet kimliği kısıtlı olmalıdır, çünkü sahte site kuranlara hazır bir araç
verilmemelidir. İkisi tek bir lisansla çözülemez, bu yüzden lisans ikiye
ayrılır.

## Devir

Bu depo bir kamu kurumuna devredildiğinde bu belge, o kurumun yetkisini ve
uygulamaya koyacağı yaptırımları yansıtacak biçimde yeniden yazılır.
