...
const SOSYAL_GORSEL = `${SITE_ADRESI}/varliklar/kiris-sosyal-onizleme.png?v=${SURUM}`;
let SPRITE = '';
...
const sosyalEtiketler = ({ baslik, ozet, yol = '' }) => {
  ...
  const gorselAciklamasi = 'Kiriş başlığı ve örnek kamu hizmeti bileşenleri';
  return `<link rel="canonical" href="${adres}">
<meta property="og:type" content="website">
<meta property="og:locale" content="tr_TR">
<meta property="og:site_name" content="Kiriş">
...
${sosyalEtiketler({ baslik: `${o.ad} · Kiriş örneği`, ozet: o.ozet, yol: `ornekler/${o.slug}/` })}
<meta name="color-scheme" content="light dark">
...
async function main() {
  ...
  await copyFile(join(KOK, 'varliklar', 'kiris-sosyal-onizleme.png'), join(CIKTI, 'varliklar', 'kiris-sosyal-onizleme.png'));
  ...
  await writeFile(
    ...
    [
      ...
      ...haritaYollari.map((y) => `  <url><loc>${SITE_ADRESI}/${y}</loc></url>`),
      '</urlset>',
      '',
    ].join('\n'),
    'utf8'
